...
@Component({
  selector: 'app-bdm-myreqs',
  templateUrl: './bdm-myreqs.component.html',
  styleUrls: ['./bdm-myreqs.component.scss']
})
export class BdmMyreqsComponent implements OnInit {
  ...
  skills: any; customer_Id: any = null ; account_manager: any = null; years_of_experience: any; job_location: any ;
